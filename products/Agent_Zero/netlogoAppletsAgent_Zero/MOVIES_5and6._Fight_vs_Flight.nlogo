          ...
          ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
          ;;              AGENT_ZERO
          ;;     MOVIES 5 and 6 Code. Version 1.0
          ;;          Fight vs. Flight
          ;;
          ;;         Joshua M. Epstein               
          ;;           February 2010 
          ...
          ;;            NetLogo 5.0 
          ;;    Sliders [30,0,4,2,1, Seed 8] 
          ;;
          ;;  Note: Fight and Flight are Switches 
          ;;  on the User Inteface      
          ;; ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;  
...
to update-probability
 ask turtles[
 let current_probability  (count patches in-radius vision with [pcolor = active-color]/(count patches in-radius vision))
...
to move-turtles                   ; Never called in 'fight vs flight.' Movement handled in take-action method
...
to take-action
   ...
   [
     if disposition > 0 [
       ifelse fight_or_flight?
         [ask patches in-radius action_radius [set pcolor destroyed-color]] ; Fight
         [facexy -12 -12 forward .1]                                        ; Flight
      ]
   ]
     end

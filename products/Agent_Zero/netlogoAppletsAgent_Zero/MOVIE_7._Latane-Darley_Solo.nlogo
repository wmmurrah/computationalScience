...
to setup-turtles
  ...
  ask turtle 0 [
                setxy 7 7 
                set color blue
                set affect 0.001 ; For delta > 0, affect(0) must be > 0, or it stays 0.
                set delta 0
                set lambda 1
...
to take-action  
  ask turtle 0 [                                          
    if disposition > threshold [setxy -9 -9]
    ]     
end
...
"turtle 1" 1.0 0 -2674135 false "" ""
"turtle 2" 1.0 0 -13345367 false "" ""

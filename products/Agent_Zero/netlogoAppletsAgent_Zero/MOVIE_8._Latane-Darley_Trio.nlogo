          ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
          ;;            AGENT_ZERO                  ;;
          ;;     MOVIE 8 Code. Version 1.0          ;;
          ;;         Latane-Darley Trio     `       ;;          
          ;;                                        ;;
          ;;         Joshua M. Epstein              ;;  
          ;;           December 2010                ;;
          ;;      Sliders [19, 0, 4, 1, 1]          ;;                              
          ;;  Note: Affect-Probability Entanglement ;;
          ;;   is OFF in update-probability routine ;;             
          ;;               Seed: 1                  ;;
          ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
to go
  ...
  update-disposition
  take-action
  deactivate-patches ; Turns them back to yellow from orange. Room fills with smoke.
  do-plots1
  do-plots2
  do-plots3
  tick
...
to update-probability
 ...
 set probability mean memory]   ; ^ (1 - affect) ; Uncomment to entangle Affect with Probability 
 ask turtle 1 [set probability 0]
 ask turtle 2 [set probability 0] ; Or set probability median memory                                          
 end
 
to update-disposition
ask turtle 0 [
   set disposition affect + probability + [weight] of red-link 1 0 * ([affect] of turtle 1 + [probability] of turtle 1 - [threshold] of turtle 1) + 
                                          [weight] of red-link 2 0 * ([affect] of turtle 2 + [probability] of turtle 2 - [threshold] of turtle 2) - threshold] 
ask turtle 1 [
   set disposition affect + probability + [weight] of red-link 0 1 * ([affect] of turtle 0 + [probability] of turtle 0 - [threshold] of turtle 0) +
                                          [weight] of red-link 2 1 * ([affect] of turtle 2 + [probability] of turtle 2 - [threshold] of turtle 2) - threshold]
ask turtle 2 [
   set disposition affect + probability + [weight] of red-link 0 2 * ([affect] of turtle 0 + [probability] of turtle 0 - [threshold] of turtle 0) +
                                          [weight] of red-link 1 2 * ([affect] of turtle 1 + [probability] of turtle 1 - [threshold] of turtle 1) - threshold]           
end
...
to take-action  
  ask turtles with [who = 0] [                                          
    if disposition > 0 [setxy -9 -9]
    ]
   ask turtles with [who = 1] [                                          
    if disposition > 0 [setxy -11 -9]
    ]
    ask turtles with [who = 2] [                                          
    if disposition > 0 [setxy -13 -9]
    ]    
end
...
to deactivate-patches
 ask patches with [pxcor > -5 and pycor > -2]     
     [if random 100 < 1 and pcolor != red - 3 [set pcolor yellow + random 2]]
end

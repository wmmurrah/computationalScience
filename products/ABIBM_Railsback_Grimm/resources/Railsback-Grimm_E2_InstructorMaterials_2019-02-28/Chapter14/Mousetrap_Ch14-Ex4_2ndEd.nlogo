...
If you are seriously interested in discrete event scheduling, you should be aware of the "Time" extension to NetLogo. This extension provides much more powerful primitives for tracking time and scheduling events at specific times. It is currently at: 
https://github.com/charlesres/time but should be packaged with NetLogo in future releases.
@#$#@#$#@
default
true
0

...
@#$#@#$#@
# Mushroom Hunt Model
This file is provided as instructor materials for chapter 2 of _Agent-based and Individual-based Modeling, 2nd edition_, by Railsback and Grimm (2019). Please do not copy or distribute this file. It is available upon request from www.railsback-grimm-abm-book.com.

This file is copyrighted 2019 by Steven F. Railsback and Volker Grimm.

The file implements the Mushroom Hunt model as modified for Exercise 4 of Chapter 2.
@#$#@#$#@
default
true
0

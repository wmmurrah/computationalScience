...
to reposition
  ; Use the satisficing trait from section 11.4
  ; Move if expected wealth increase rate is below the threshold
  ; Position destinations do NOT include the current patch
...
;to reposition  This is the original reposition submodel; replaced with satisficing
;
...
to do-accounting
  ...
  ; Revised for satisficing version
  set current-utility utility-here

end

to-report utility-here  ; Now, a turtle procedure

  report profit * (1 - annual-risk)

end

;to-report utility-for [a-turtle]  REPLACED with new utility reporter
...
@#$#@#$#@
# BusinessInvestors_Sect11-4_2ndEd.nlogo
...
This file implements the first version of the Business Investor model, modified to use _satisficing_ behavior as described in Section 11.4. This model description has not been updated with this new submodel.
...
<experiments>
  ...
  <experiment name="income-threshold-sensitivity" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>mean [wealth] of turtles</metric>
    <steppedValueSet variable="income-threshold" first="1000" step="100" last="50000"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@

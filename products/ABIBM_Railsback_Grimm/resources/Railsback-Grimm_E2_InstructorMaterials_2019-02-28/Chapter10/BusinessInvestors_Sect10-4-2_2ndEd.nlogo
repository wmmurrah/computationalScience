...
This file implements the first version of the Business Investor model, as described in Section 10.4.1, but modified as described in Section 10.4.2 to make the sensing radius variable (as a slider).
...
@#$#@#$#@
<experiments>
  <experiment name="Sensing-radius_FinalValues" repetitions="10" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="Sensing-radius_TimeSeries" repetitions="10" sequentialRunOrder="false" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>mean [wealth] of turtles</metric>
    <metric>standard-deviation [wealth] of turtles</metric>

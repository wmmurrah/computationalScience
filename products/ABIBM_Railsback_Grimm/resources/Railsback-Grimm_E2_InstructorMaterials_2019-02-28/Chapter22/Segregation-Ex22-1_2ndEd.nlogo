...
;; New procedure that moves turtle to patch where it is happy
to find-good-spot

  let good-spots patches with [(not any? turtles-here) and (is-happy? myself)]
  if any? good-spots
  [

...
to setup
 ...
 ; set test-output-on? false Moved to Interface
...
to update-similarity   ; a patch procedure
  ...
  [
    ...
    ; Each neighbor adds its similarity to output line

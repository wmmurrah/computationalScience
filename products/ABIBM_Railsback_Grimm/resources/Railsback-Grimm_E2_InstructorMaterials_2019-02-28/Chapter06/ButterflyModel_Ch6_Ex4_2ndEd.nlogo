...
to setup
  ...
  ; Add a test output file
  if file-exists? "TestOutput.csv" [file-delete "TestOutput.csv"]
...
to move  ; The butterfly move procedure, in turtle context
  ...
  ; Write the elevation turtle moved to, using "print" to get a carriage return
...
This file is provided as instructor materials for Chapter 6 of _Agent-based and Individual-based Modeling, 2nd edition_, by Railsback and Grimm (2019). Please do not copy or distribute this file. It is available upon request from www.railsback-grimm-abm-book.com.

This file is copyrighted 2019 by Steven F. Railsback and Volker Grimm.

The file implements the Butterfly model with the code needed to produce the output file used in Exercise 4 of Chapter 6. 

...
to move  ; The butterfly move procedure, in turtle context
  ...
  ; Now write out the random number and q, then the elevation
...
The file implements the Butterfly model with the code needed to produce the output file used in Exercise 5 of Chapter 6. 

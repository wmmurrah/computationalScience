...
; Updated for NetLogo 6 by SF Railsback, 2017
;--------------------------------------------------------------------------------------
...
A full ODD description of this model is available on the web site for _Agent-based and Individual-based Modeling: A Practical Introduction_ by Railsback and Grimm, 2nd Edition: www.railsback-grimm-abm-book.com.
@#$#@#$#@
default
true
0

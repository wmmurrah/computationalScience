          ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
          ;;             AGENT_ZERO                 
          ;;    MOVIE 13 Code. Version 1.0
          ;;           Christmas Cycles
          ;;    (Seasonal Demand Oscillations)        
          ;;                 
          ;;           Joshua M. Epstein        
          ;;            November 2012           
          ;;   Sliders [300, 0.1, 4, 1, 1] Seed 1             
          ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
to setup-turtles
  ...
  ask turtle 1 [                                      
                setxy  5 2 ;random-xcor random-ycor
                set color blue
                set affect 0.001
                set delta 0
                set lambda 1
  ...
  ask turtle 2 [                                      
                setxy 11 12 ;random-xcor random-ycor
                set color blue
                set affect 0.001
                set delta 0
                set lambda 1
...
to activate-patches  
 ask patches                                                                   
      [if random 1000 < attack_rate * sin ticks / 10 and pcolor != red - 3 [set pcolor orange + 1]]
end

to deactivate-patches
 ask patches             
  [if random 100 < 8 and pcolor != red - 3 [set pcolor yellow + random 2]]; they hide again
end

to quit-shopping
   ask patches     
  [if random attack_rate * sin ticks >= 0 and attack_rate * sin ticks + random 5 < 10 [set pcolor yellow + random 2]] 
end
...
to do-plots1
   ...
   set-current-plot-pen "turtle 0"
    ...
    plot [disposition] of turtle 1 ; OR + [disposition] of turtle 1 + [disposition] of turtle 2

...
to take-action  
  ask turtles [                                            
    if disposition > 0 [ask patches in-radius action_radius [set pcolor 69.5]] ; Jasmine color
    ]
...
to activate-patches  
 ask patches                
       [if random 1000 < attack_rate and pcolor != 69.5 [set pcolor orange + 1]]
end

to deactivate-patches
 ask patches      
  [if random 100 < 8 and pcolor != 69.5 [set pcolor yellow + random 2]]     
end
